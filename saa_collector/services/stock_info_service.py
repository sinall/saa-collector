...
class StockInfoService(BasicStockService):
    def __init__(self):
        super().__init__()
    ...
    def get_stock_info_list(self, scode_list):
        ...
        stock_response = self.query_records(scode_list, 'p_stock2101')
        ...
        company_response = self.query_records(scode_list, 'p_stock2100')
