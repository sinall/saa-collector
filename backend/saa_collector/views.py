...
'saa_prices_ex': 'date',
            ...
            'saa_dividends': 'date',
            'saa_raw_main_business': 'report_date',
            'saa_capitals': 'date',
...
class TypeBrowseDataView(APIView):
    ...
    TABLE_CONFIG = {
        ...
        'saa_raw_balance_sheet': {'date_column': 'report_date', 'order': 'symbol ASC, report_date DESC'},
        'saa_raw_income_statement': {'date_column': 'report_date', 'order': 'symbol ASC, report_date DESC'},
        'saa_raw_cash_flow_statement': {'date_column': 'report_date', 'order': 'symbol ASC, report_date DESC'},
        'saa_raw_main_business': {'date_column': 'report_date', 'order': 'symbol ASC, report_date DESC'},
...
class DataCompletenessCheckView(APIView):
    ...
    def check_data_missing_batch(self, stocks, trade_dates, data_type, frequency, start_date=None, end_date=None):
        table_mapping = {
            ...
            'main_business': ('saa_raw_main_business', 'report_date'),
