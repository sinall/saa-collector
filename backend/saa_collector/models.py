...
class ExternalApiCacheEntry(models.Model):
    ...
    request_url = models.TextField('请求URL', blank=True, default='')
    request_body = models.TextField('请求Body', blank=True, default='')
    response_status_code = models.PositiveIntegerField('响应状态码', null=True, blank=True)
    response_headers_json = models.JSONField('响应头', default=dict)
    response_content_type = models.CharField('响应Content-Type', max_length=255, blank=True, default='')
    response_encoding = models.CharField('响应编码', max_length=50, blank=True, default='')
    response_filename = models.CharField('响应文件名', max_length=255, blank=True, default='')
    response_body = models.BinaryField('原始响应Body')
    response_sha256 = models.CharField('响应SHA256', max_length=64, blank=True, default='')
